...
4. **(Phase 4a, 구현 완료)** 4개 BigQuery 중간 테이블(user_static/user_dynamic/video_feature/training_entity) 배치 생성 (#207)
5. **(Phase 4b, 구현 보류)** user_topic_embedding/category_embedding/user_category_similarity 배치 생성 + Feast `get_historical_features()` 경유 전환 (#214)
