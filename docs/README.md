...
- [Plan — 실험 executor Phase 2](plans/2026-08-06-experiment-executor-phase2.md) — Candidate API부터 branch-creator·Codex·verifier·commit/push·8-container Job·배포 검증까지 7단계 구현 순서 (#557)
...
- [실험 executor Phase 2 구현 계획](plans/2026-08-06-experiment-executor-phase2.md) —
  Candidate API부터 branch-creator·Codex·verifier·commit/push·8-container Job·배포 검증까지 7단계 구현 순서
