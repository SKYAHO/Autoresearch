...
`feature_store/feature_store.yaml`에서 다음 항목 확인/수정:

```yaml
offline_store:
  project: autoresearch-skyaho            # 본인 GCP 프로젝트 ID
...
3. `feature_store/feature_store.yaml`의 project, connection_string, 버킷 이름 직접 수정
