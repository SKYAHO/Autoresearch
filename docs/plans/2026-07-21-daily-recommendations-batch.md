...
- [x] **Step 1: 실패하는 테스트 작성** — `tests/test_serving_model_registry.py`
...
- [x] **Step 3: 구현** — `src/serving/model_loader.py`
...
- [x] **Step 1: 실패하는 테스트 작성** — `tests/test_virtual_user_adapter.py`
...
- [x] **Step 3: 구현** — `src/pipeline/virtual_user_adapter.py`
...
- [x] **Step 1: 실패하는 테스트 작성** — `tests/test_daily_recommendations.py`
...
- [x] **Step 3: 구현** — `src/pipeline/daily_recommendations.py` (헬퍼 부분)
...
- [x] **Step 1: 실패하는 테스트 추가** — `tests/test_daily_recommendations.py` 말미에
...
- [x] **Step 3: 구현** — `daily_recommendations.py`에 추가
...
- [x] **Step 4: db-dtypes 의존성 추가** — BQ `to_dataframe()`의 잠재 미선언 의존성(2026-07-21 실측)
...
- [x] **Step 1: 실패하는 이미지 공개 명령 테스트 작성** — `tests/test_release_workflow.py`
...
- [x] **Step 2: application image와 CI/release smoke 경로 갱신**
