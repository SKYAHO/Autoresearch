...
- [ ] **Step 1: raw 이슈가 parser 없이 clone되는 실패 테스트 작성**
...
- [ ] **Step 2: launcher와 phase2에서 본문 hash 환경 변수가 사라지는 실패 테스트 작성**
...
- [ ] **Step 3: 관련 테스트가 현재 parser/hash 의존으로 실패하는지 확인**
...
- [ ] **Step 4: workspace parser·hash·branch 재계산 제거**
...
- [ ] **Step 2: 기존 민감어·heading 때문에 raw 본문이 차단되지 않는 테스트 작성**
