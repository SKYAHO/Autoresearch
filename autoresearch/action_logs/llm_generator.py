...
would_like/search_keyword만 판단한다. 전역 2% 정규화·timestamp·제약 강제는 pipeline(코드).
"""
import hashlib
import json
import logging
...
{{"judgments": [
  {{"video_id": "...", "click_propensity": 0.0, "watch_fraction": 0.0, "would_like": false, "search_keyword": null}}
]}}
