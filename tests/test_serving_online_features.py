...
def _first_response() -> Mapping[str, Sequence[object]]:
    return {
        ...
        "channel_subscriber_count": [10_000, 10_000, 10_000],
        "channel_view_count": [500_000, 500_000, 500_000],
        "channel_video_count": [120, 120, 120],
    }
        ...
        responses=[
            {
                ...
                "channel_subscriber_count": [None, None],
                "channel_view_count": [None, None],
                "channel_video_count": [None, None],
            },
            {
                "user_id": ["user-1"],
                "category_id": ["unknown"],
