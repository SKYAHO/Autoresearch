...
__arch__ = {
    "stage": "training",
    "role": "학습과 정책 시뮬레이션에서 공유하는 video/user/interaction 피처를 DuckDB SQL로 조립합니다.",
    "owns": [
        "video_feature 계산(channel 통계 포함)",
        "user_static/user_dynamic 피처 point-in-time 집계",
        "preferred_category/topic_similarity/match interaction 피처 계산",
        "학습·시뮬레이션 공용 피처 컬럼 계약",
    ],
    "not_owns": [
        "임베딩 API 호출 자체",
        "BigQuery/CSV 원본 데이터 로딩",
        "정책별 노출 선택",
        "모델 학습과 추론 서비스",
    ],
}
