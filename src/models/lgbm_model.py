...
class LGBMModel(CTRModel):
    ...
    def __init__(
        ...
        Args:
            ...
            random_state: 시드.
            feature_fraction: 트리별로 사용할 피처 비율.
            bagging_fraction: 트리별로 사용할 학습 샘플 비율.
            bagging_freq: bagging을 수행할 트리 간격. 0이면 비활성화.
        """
    ...
    def load(cls, path: str) -> "LGBMModel":
        ...
        instance = cls(
            ...
            feature_fraction=params.get("feature_fraction") or 1.0,
            bagging_fraction=params.get("bagging_fraction") or 1.0,
            bagging_freq=params.get("bagging_freq") or 0,
        )
